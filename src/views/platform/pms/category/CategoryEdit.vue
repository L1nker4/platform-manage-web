...
export default {
  ...
  methods: {
    ...
    setFormValues({...category}) {
      ...
      this.form.setFieldsValue({'name': category.name})

      this.form.getFieldDecorator('productCount')
      this.form.setFieldsValue({'productCount': category.productCount})

      this.form.getFieldDecorator('productUnit')
      this.form.setFieldsValue({'productUnit': category.productUnit})

      this.form.getFieldDecorator('navStatus')
      this.form.setFieldsValue({'navStatus': category.navStatus})

      this.form.getFieldDecorator('showStatus')
      this.form.setFieldsValue({'showStatus': category.showStatus})

      this.form.getFieldDecorator('keywords')
      this.form.setFieldsValue({'keywords': category.keywords})

      this.form.getFieldDecorator('description')
      this.form.setFieldsValue({'description': category.description})

      this.form.getFieldDecorator('sort')
      this.form.setFieldsValue({'sort': category.sort})
    ...
    handleSubmit () {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          category.logo = this.category.logo
          console.log(category)
          this.$put('category', category).then(() => {
            this.reset()
            this.$emit('success')
          }).catch(() => {
            this.loading = false
